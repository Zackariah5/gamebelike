...
public class Game {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        int choice;
        //boolean openingDialogueDone = false;
        boolean openingDialogueDone = true;
        //String name = "";
        String name = "Zack";
        ...
        while (true) {
            if (!openingDialogueDone) {
                dramaticText("You wake up in a hospital bed, your body feeling heavier than usual. With so many wires hooked up to you, there's no way you can leave the bed. You call out for help.");
                player.speak("Hello?");
                pause(5);
